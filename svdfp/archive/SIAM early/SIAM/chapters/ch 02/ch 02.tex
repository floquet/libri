...
ÒOut of intense complexities intense simplicities emerge.\\
...
%   \includegraphics[ width = 5in ]{pdf/post_mortem/earlydecomp.pdf} 
   \includegraphics[ ]{pdf/post_mortem/c321} 
   \caption[A schematic look at the SVD]{A schematic look at the \svdl. In the previous chapter we took a matrix with one linearly independent column vector (down arrow) and one linearly independent row vector (right arrow) and resolved the domain and codomain into four fundamental subspaces shown here.}
   \label{fig:pm:decomp}
\end{figure}
...
%%
\input{chapters/"ch 02"/interpretation}
\input{chapters/"ch 02"/bounty}
\input{chapters/"ch 02"/exercises}
