...
\subsection{\label{ssec:zonal approx}Zonal Approximation}  %   SS   SS   SS   SS   SS   SS   SS   SS   SS   SS   SS   SS
  ...
  %\end{split}
  \end{equation*}
There are $m=2$ measurements, $n=3$ fit parameters, and the matrix rank is $\rho = 2$.
...
Going back to \eqref{eq:axeb}, there is a solution when the data vector $b$ can be expressed as a combination of the column vectors of $\A{}$. In this 
...
\section{\label{sec:ftola}Fundamental Theorem of Linear Algebra}  %    S    S    S    S    S    S    S    S    S    S    S    S    S    S    S    S
  \begin{table}[htdp]  %  T A B L E
    \caption[The Fundamental Theorem of Linear Algebra]{\index{Fundamental Theorem of Linear Algebra!orthogonal decomposition}The Fundamental Theorem of Linear Algebra }
    \begin{center}
...
%\chapter{\label{ch:my chapter}My Chapter}   %   %   %   %   %   %   %   %   %   %   %   %   %   %   %   %
...
{\bf{Subspace decomposition:}}
    ...
    {\small{
    \begin{table}[h!]
    	\caption[Subspace decomposition for \eqref{eqn:ideal}]{Subspace decomposition for the $\A{}$ matrix in \eqref{eqn:ideal}.}
    	\begin{center}
    		\begin{tabular}{rccccccccc}
    		  %
...
\emph{Finding ÒnonobviousÓ nilpotent matrices}, (2005) \\
